...
const ModalHeader1 = ({
  ...
  return (
    <header
      className={clsx("h-14 w-full rounded-t-2xl py-4 md:h-auto md:py-6", {
    ...
    >
      {title && (
        <h3
          className={clsx("mx-auto flex w-4/6 items-center justify-center text-2xl font-semibold", {
      ...
      >
        <CloseIcon
          className={clsx("block h-6 w-6 transition-colors duration-200", {
