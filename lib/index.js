import { jsxs as F, jsx as c, Fragment as Se } from "react/jsx-runtime";
...
const Re = ({ children: t }) => {
  ...
  "header",
  {
    ...
    children: [
      t && /* @__PURE__ */ c("h4", { className: Z["modal__header-title"], children: t }),
      /* @__PURE__ */ c("button", { type: "button", className: Z["modal__header-close"], onClick: e, children: /* @__PURE__ */ c(He, { className: Z["modal__header-close-icon"] }) })
    ]
  }
);
function Xe(t) {
...
function vt({ children: t }) {
  const e = Fe();
  return /* @__PURE__ */ c(ge.Provider, { value: e, children: t });
}
function Ve(t) {
  return Te(ge) ?? t;
}
  ...
  return /* @__PURE__ */ c(
    "button",
    {
      ...
      children: r && p !== "none" ? /* @__PURE__ */ F(Se, { children: [
        /* @__PURE__ */ c(we, { className: B("btn__loader", `btn__loader--variant-${p}`) }),
...
function ze({
  ...
  Qe(() => {
    const _ = v.current;
    if (!_ || l) return;
    const h = (o === "base" || o === "fullscreen") && n, C = p.current;
    let d = 0, P = 0, D = 0, q = 0, I = !1, M = !1, O = 0, S = !1;
    const G = (a) => {
    ...
    function b() {
      d = 0, P = 0, D = 0, q = 0, I = !1, M = !1, O = 0, S = !1;
    }
    function le() {
      Y(!0), b(), setTimeout(() => {
        r?.remove(e), s();
    ...
    const k = (a) => {
      ...
      const w = (/* @__PURE__ */ new Date()).getTime() - q, N = (d - P) / (v.current?.clientHeight || 0);
  ...
  function x() {
    ...
    h && (C = h.scrollTop === 0);
    let d = !0;
    return h && (d = h.scrollTop + h.clientHeight === h.scrollHeight), { isScrollable: _, isTop: C, isBottom: d };
  }
  function V() {
    Ye(() => {
      Y(!0), i((_) => ({
...
function dt({
  ...
  const D = Ve(C), q = X(null), I = X(null), M = X(null), O = X(null), S = X(null), G = X(null), ae = xe(), b = T && (d === "base" || d === "fullscreen"), [le, K] = ne(!1), [me, Q] = ne(O.current?.clientHeight), { closeAnimation: E, transformState: W, handleClose: z } = ze({
    id: t,
    modalRef: I,
    modalHeaderRef: M,
    scrollAreaRef: S,
  ...
  const a = ie(() => _ ? _(k) : null, [_, k]), L = !l && (b || a) ? /* @__PURE__ */ c("div", { ref: M, children: a }) : /* @__PURE__ */ c("div", { ref: M, children: /* @__PURE__ */ c(Ne, { label: r || void 0, onClose: k }) }), g = ie(() => h ? h(k) : null, [h, k]), R = !l && g ? /* @__PURE__ */ c("footer", { className: m.modal__footer, children: g }) : null, A = B(m.modal__container, {
    [m["modal__container--fullscreen"]]: d === "fullscreen",
    [m["modal__container--menu"]]: d === "menu",
    [m["modal__container--overlay-90"]]: d === "overlay-90",
    [m["modal__container--overlay-95"]]: d === "overlay-95",
    [m["modal__container--overlay-auto"]]: d === "overlay-auto",
    [m["modal__safe-top"]]: d !== "fullscreen" && i
  }), $ = B(m.modal__main, m[`modal__main--${d}`], {
    [m[`modal__main--${P}`]]: d !== "fullscreen",
    [m["modal__main--opacity-0"]]: !me,
    [m["modal__main--animate-slide-up-90"]]: !E && (d === "menu" || d === "overlay-90" || d === "overlay-auto"),
    [m["modal__main--animate-slide-up-95"]]: !E && d === "overlay-95",
    [m["modal__main--animate-slide-right"]]: !E && (d === "fullscreen" || d === "base"),
    [Y]: !!Y
  });
  function H(f) {
    return u ? /* @__PURE__ */ c(Re, { children: f }) : f;
  }
  return H(
    /* @__PURE__ */ F(
      "div",
        ...
        children: [
          /* @__PURE__ */ F(
            "div",
            {
              ...
              children: [
                L,
                /* @__PURE__ */ c("div", { className: m.modal__body, children: /* @__PURE__ */ c(
                  Le,
                  {
                    id: e,
                    ...
                    children: l ? /* @__PURE__ */ c("div", { className: m.modal__loader, children: /* @__PURE__ */ c(we, { text: p }) }) : o
                  }
                ) }),
                R
              ]
          ...
          /* @__PURE__ */ c(
            "div",
            {
              className: B(m.modal__backdrop, {
                [m["modal__backdrop--hidden"]]: E && d !== "fullscreen" || E && b
              }),
              style: {
                willChange: "opacity"
              }
